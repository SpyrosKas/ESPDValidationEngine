...
const DatPer = () => {
  ...
  const onFileAdd = () => {
    if (title === "Upload ESPD Request") {
      ...
      setTitle("Upload ESPD Response");
    } else if (title === "Upload ESPD Response" && firstFileUploaded === true) {
      setTitle("Upload Files");
    }
  };

  const onFileDelete = () => {
    if (title === "Upload ESPD Response") {
      setfirstFileUploaded(false);
      setTitle("Upload ESPD Request");
    }
  };
  ...
  return (
    <div>
      ...
      <div className="AppDatPer">
        ...
        >
          <i className="fas fa-cloud-upload-alt" /> Data Percistence
        </h4>
